...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('Sending login request to:', 'https://voyagevault-1464.azurewebsites.net/api/login');
    console.log('Payload:', payload);

    try {
      const response = await fetch('https://voyagevault-1464.azurewebsites.net/api/login', {
        method: 'POST',
        headers: {
