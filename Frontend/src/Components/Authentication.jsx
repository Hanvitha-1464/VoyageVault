...
const AuthPages = () => {
  ...
  const validateForm = () => {
    ...
    if (!isLogin && formData.username.length > 50) {
  ...
  const handleSubmit = async (e) => {
    ...
    const endpoint = isLogin ? 'https://voyagevault-1464.azurewebsites.net/api/login' : 'https://voyagevault-1464.azurewebsites.net/api/signup';
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400">
              ...
              <button
                ...
                disabled={isLoading}
                className="ml-2 text-purple-400 hover:text-purple-300 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
